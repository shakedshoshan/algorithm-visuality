    ...
    const IterativeSearchVisualizer: React.FC = () => {
      ...
      const generateLinkedList = () => {
        ...
        const newLinkedList: LinkedListNode[] = nodes.map((value, index) => ({
          value,
      ...
      const search = async () => {
        ...
        while (current !== null) {
          ...
          if (linkedList[current].value === target) {
            setFound(true)
      ...
      return (
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            <CardTitle className="font-bold text-2xl">Iterative Search Visualizer for Linked List</CardTitle>
            <div className="text-sm font-normal">
              <p><strong>Time Complexity: O(n)</strong></p>
              <p><strong>Space Complexity: O(1)</strong></p>
            </div>
            <CardDescription>
              Iterative search in a linked list traverses each node sequentially until the target value is found or the end of the list is reached. It efficiently works with both singly and doubly linked lists.
            </CardDescription>
          </CardHeader>
          <CardContent>
    ...
    export default IterativeSearchVisualizer